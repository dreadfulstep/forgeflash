...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		l('links').innerHTML=(Game.beta?'<a href="../" target="blank">Live version</a> | ':'<a href="//orteil.dashnet.org/cookieclicker/beta/" target="blank">Try the beta!</a> | ')+'<a href="//orteil.dashnet.org/cookieclicker/" target="blank">Biscuit Beater Classic</a>';
		//l('links').innerHTML='<a href="//orteil.dashnet.org/experiments/cookie/" target="blank">Biscuit Beater Classic</a>';
	...
	Game.Logic=function()
	{
		...
		if (Game.T%(Game.fps)==0) document.title=Beautify(Game.cookies)+' '+(Game.cookies==1?'cookie':'cookies')+' - Biscuit Beater';
